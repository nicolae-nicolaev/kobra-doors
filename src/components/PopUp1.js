      ...
      <div className="fixed flex flex-col h-full">
        ...
        <div className="bg-[#D9D9D9] flex-grow w-[415px] max-h-[854px] overflow-y-auto p-4">
          <div className="flex justify-center mb-4">
            <button
              className={`py-2 px-4 text-[20px] mt-[10px] rounded-full text-white font-bold ${
            ...
            <button
              className={`py-2 px-4 text-[20px] ml-[50px] mt-[10px] rounded-full text-white font-bold ${
